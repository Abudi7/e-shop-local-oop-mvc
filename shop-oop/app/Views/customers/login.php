...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-md-10">
          <form action="<?= BASEROOT ?>CustomersController/login" method="POST"> <!-- Changed method to POST -->
            ...
            <div class="form-group">
              ...
              <input type="password"  class="form-control" id="paasword" name="password" placeholder="Password">
            </div>
